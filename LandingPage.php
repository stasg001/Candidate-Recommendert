        ...
        <div id="ABOUT" class="main-section bottom-padding">
            ...
            <div class="columns-2 w-row">
                <div class="column-3 w-col w-col-6">
                    <img src="img4.jpg" width="358" srcset="img4.jpg 1080w, img4.jpeg 1300w" sizes="(max-width: 479px) 73vw, (max-width: 767px) 67vw, (max-width: 991px) 43vw, 358px" alt="" class="image-4"/>
                </div>
                <div class="column-4 w-col w-col-6">
                    <p class="paragraph-2">Our algorithm will work on finding the best suitable job for you based on your profile and will notify the organisation about it so you can attend interviews as and when needed</p>
                </div>
            </div>
        </div>
