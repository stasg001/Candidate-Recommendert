...
<body>
    ...
    <div class="content">
        <div class="blog-list w-dyn-list">
            ...
            <h2>Add new Job</h2>
            <p>Create new job position by specifying the details such as name, department and description</p>
            <form method="POST">
                ...
                <input type="text" class="form-control" name="dept" id="pwd">
                </div>
                <div class="form-group">
                <label for="comment">Description:</label>
                <textarea class="form-control" rows="5" id="comment" name="desc"></textarea>
                <div class="jbbtn"><input type="submit" name="submit" value="Create Job"></div>
                </div>
            </form>
            <?php
                if(isset($_POST['submit'])){
                    ...
                    $dept = $_POST['dept'];
                    $desc = $_POST['desc'];
                    //Id	Name	Description	Dept
                    if($name && $dept && $desc){
                        $sql = "INSERT INTO Job (Name,Description,Dept)
                               VALUES ('$name','$desc', '$dept')";
